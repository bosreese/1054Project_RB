...
public abstract class DrawableObject
{
   ...
   public void act(float timera, float timerw, float timers, float timerd)
   {
      float forcexdirection = (timera+timerd); //calculating the force in the xdirection
      float forceydirection = (timerw+timers); //calculating the force in the ydirection
      
     setX(forcexdirection+x);
     setY(forceydirection+y);
